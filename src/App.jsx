...
export default function App() {
        ...
        <div style={{ flex: '1 1 500px', ...darkFuturisticBackgroundStyle, padding: 'clamp(3rem, 6vh, 6rem)', display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative' }}>
          ...
          <div style={{ marginTop: 'clamp(3rem, 6vh, 5rem)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}> 
            <div style={{ maxWidth: '550px' }}>
              ...
              <p style={{ color: '#ffffff', fontSize: 'clamp(1.1rem, 2.2vh, 1.25rem)', lineHeight: '1.5', marginBottom: '1.6rem', opacity: '0.95' }}>{t('subtitle')}</p>
              <div style={{ width: '100%', height: '1px', backgroundColor: 'rgba(255,255,255,0.2)', marginBottom: '1.6rem' }}></div>
              <p style={{ color: '#ffffff', fontSize: 'clamp(1.05rem, 2vh, 1.15rem)', marginBottom: '1.6rem', lineHeight: '1.5', opacity: '0.95' }}>{t('desc')}</p>
  ...
  if (isFinished) {
    ...
    return (
      <>
        <div className="results-page-wrapper" style={{ minHeight: '100vh', width: '100%', ...lightFuturisticBackgroundStyle, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '120px 2vw 60px 2vw', boxSizing: 'border-box', position: 'relative' }}>
          {floatingControls}
          ...
          <div className="results-main-card" style={{ position: 'relative', zIndex: 1, maxWidth: '1400px', width: '100%', minHeight: '85vh', height: 'auto', background: '#ffffff', borderRadius: '24px', boxShadow: '0 30px 70px rgba(0,0,0,0.5)', boxSizing: 'border-box', overflow: 'visible', display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="no-print print-content-padding" style={{ padding: '3vh 4vw', display: 'flex', flexDirection: 'column' }}>
              ...
              {/* NIVEL DE EQUILIBRIO WEB */}
              <div style={{ margin: '1.6rem 0', padding: '1.5rem', background: '#f8fafc', borderLeft: `4px solid ${riskLabel.color}`, borderRadius: '6px' }}>
                <p style={{ margin: 0, fontSize: '1rem', fontWeight: 600, color: '#0f172a' }}>
                  Nivel de equilibrio organizacional
                </p>
                <p style={{ marginTop: '0.4rem', color: riskLabel.color, fontWeight: 700, margin: '0.4rem 0 0 0' }}>
                  {riskLabel.text}
                </p>
                <p style={{ marginTop: '0.6rem', color: '#334155', lineHeight: '1.5', margin: '0.6rem 0 0 0' }}>
                  La diferencia entre las dimensiones evaluadas indica que existen áreas con niveles de madurez desiguales. Atender estas brechas permitirá una adopción más estable y estratégica de iniciativas de IA.
                </p>
              </div>
              ...
              <div className="action-plan-section">
                 ...
                 {/* ACTIVACIÓN ESTRATÉGICA WEB (CON GRID) */}
            ...
            {/* ========================================================
                ...
                Estilo Editorial, McKinsey/Deloitte
                ======================================================== */}
            <div className="print-only-block" style={{ padding: '0 20px' }}>
              ...
              <div className="print-document-header print-avoid-break" style={{ marginBottom: '1.6rem' }}>
                <div className="print-title-container">
                  <h1 style={{ fontSize: '1.6rem', fontWeight: '900', color: '#0f172a', marginBottom: '0.3rem', marginTop: 0 }}>AI Maturity Diagnostic Report</h1>
                  <p style={{ color: '#64748b', fontSize: '0.95rem', margin: 0 }}>AI Readiness Assessment</p>
                </div>
              ...
              {/* DEL DIAGNÓSTICO A LA IMPLEMENTACIÓN PDF (NUEVO CIERRE / CTA) */}
              <div className="print-avoid-break print-cta-block" style={{ marginBottom: '1.6rem' }}>
                ...
                <a href="mailto:contact@onedatasoftware.com" className="print-cta-btn print-link" style={{ display: 'inline-block', padding: '10px 26px', backgroundColor: '#3533cd', color: '#ffffff', textDecoration: 'none', borderRadius: '6px', fontWeight: '600' }}>Contactar al equipo</a>
              </div>

              {/* FOOTER EJECUTIVO - 100% EXCLUSIVO DEL PDF */}
              <div className="print-footer-executive print-only-flex">
                <div>
                  Diagnóstico de Madurez en IA Generativa<br/>
                  OneData + AWS
                </div>
